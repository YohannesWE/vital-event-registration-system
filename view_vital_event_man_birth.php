    ...
    ?>
        ...
        <table border="1px">
            <tr>
                ...
                <th class="tt">Grandfather's Name</th>
            ...
            if ($result->num_rows > 0) {
                while ($row = mysqli_fetch_assoc($result)) { 
                    ...
                    <tr>
                        ...
                        <td class="td_tale"><?php echo $row['f_name']; ?></td>
                        <td class="td_tale"><?php echo $row['father_fname']; ?></td>
                        <td class="td_tale"><?php echo $row['father_mname']; ?></td>
                        <td class="td_tale"><?php echo "{$row['Mother_fname']} {$row['Mother_mname']}"; ?></td>
                        ...
                        <td class="td_tale">  <a class="btn btn-success" href="view_certficate_birth_manager.php?username=<?php echo $row['username']; ?>">View</a></td>
                        <td class="td_taleee">
   
        <a href="delete_event_birth_manager.php?username=<?php echo $row['username']; ?>" class="btn btn-danger">Delete</a></td>
        <td class="td_taleee">   <a href="update_event_birth_manager.php?username=<?php echo $row['username']; ?>" class="button">Update</a>
