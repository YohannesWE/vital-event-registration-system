    ...
    <?php else: ?></center>
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="f_name" minlength="3" pattern="[ሀ-ፐ]+" title="እባክዎን ጽሑፍ ብቻ ያስገቡ !" id="f_name">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="m_name"><?= __('Deceased Middle Name')?>:</label>
                        <input type="text" name="m_name" minlength="3" pattern="[ሀ-ፐ]+" title="እባክዎን ጽሑፍ ብቻ ያስገቡ !" id="m_name">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="l_name"><?= __('Deceased Last Name')?>:</label>
                        <input type="text" name="l_name" minlength="3" pattern="[ሀ-ፐ]+" title="እባክዎን ጽሑፍ ብቻ ያስገቡ !" id="l_name">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="ጾታ"><?= __('Gender')?>:</label>
                        <select name="Sex" id="Sex" required>
                            <option value="">ጾታ ምርጫ</option>
                ...
                <div class="col-md-4">
                <div class="form-group">
    <label for="አማርኛ"><?= __('Nationality')?>:</label>
    <select name="Nationality" id="Nationality" required>
        <option value="" selected disabled>ዜግነት ይምረጡ</option>
    ...
    document.getElementById('Death_date').setAttribute('max', today);
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="Death_place"  id="Death_place" minlength="3" pattern="[ሀ-ፐ]+" title="እባክዎን ጽሑፍ ብቻ ያስገቡ !">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("dateField").value = formattedDate;
        ...
        <div class="form-group">
            ...
            <select name="Marriage_status" id="Marriage_status" required>
                ...
                <option value="Divorced"> የተፋታ/ች </option>
                <option value="Widowed"> የሞተበት/ባት </option>
         ...
         <input type="text" name="r_fname" id="r_fname" minlength="3" pattern="[ሀ-ፐ]+" title="እባክዎን ጽሑፍ ብቻ ያስገቡ !" maxlength="50" >
             </div>
         </div>
         <div class="col-md-4">
         <div class="form-group">
             <label for="r_mname"><?= __('Father Name')?>:</label>
         <input type="text" name="r_mname" id="r_mname" minlength="3" pattern="[ሀ-ፐ]+" title="እባክዎን ጽሑፍ ብቻ ያስገቡ !" maxlength="50" >
             </div>
         </div>
    ...
    <div class="form-group">
        ...
        <select name="Relationship_type" id="Relationship_type" required>
             ...
             <option value="Wife">ሚስት</option>
             <option value="Hasband">ባል</option>
             <option value="Spouse">ትዳር አጋር</option>
             <option value="Child">ልጅ</option>
             <option value="Parent">ወላጅ</option>
             <option value="Sibling">ወንድም/እህት</option>
             <option value="Grandparent">አያት</option>
             <option value="Grandchild"> የልጅ ልጅ </option>
             <option value="police">ፖሊስ</option>
             <option value="Other">ሌላ</option>
        </select>
    </div>
</div>
...
<div class="form-groupck">
    ...
    <script>
        function showChatbot() {
            ...
            <center>
  <div class="form-group">
    <input type="submit" name="submit" value="መዝግብ" class="custom-register-btn">
