                ...
                <?php if ($result && mysqli_num_rows($result) > 0) : ?>
                    <table border="1px">
                        <tr>
                            ...
                            <th class="ttt">Husband's Age</th>
                            <th class="ttt">Wife's Age</th>
                            <th class="ttt">Kebele</th>
                            <th class="ttt">Date of Marriage </th>
                            <th class="ttt">Marital Status</th>

                            <th class="ttt">Marriage Status</th>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                            <tr>
                                ...
                                <td class="tt"><?php echo htmlspecialchars($row['Hasband_age']); ?></td>
                                <td class="tt"><?php echo htmlspecialchars($row['wife_age']); ?></td>
                                <td class="tt"><?php echo htmlspecialchars($row['marriage_kebele']); ?></td>
                                ...
                                <td class="tt">  <a  class="btn btn-success" href="view_certficate_marriage_manager.php?username=<?php echo $row['username']; ?>">view</a></td>
                                <td class="td_taleee">
                            <a  class="btn btn-danger" href="delete_event_marriage_manager.php?username=<?php echo $row['username']; ?>">Delete</a>  </td>
                            <td class="td_taleee"> <a  class="button" href="update_event_marriage_manager.php?username=<?php echo $row['username']; ?>">Update</a>
                        </td>
                            </tr>
                        <?php endwhile; ?>
                    </table>
