...
<head>
    ...
    margin-right: 5px; /* Adjust as needed */
        ...
        .form-group select {
            width: 100%;
            padding: 10px;
            border: 1px solid rgba(73, 140, 184, 0.47);
            border-radius: 4px;
    ...
    .message {
    color:rgb(0, 0, 0); /* Error message text color */
...
.language-options {
    ...
    min-width: 100px;
    box-shadow: 0px 4px 8px rgba(73, 140, 184, 0.47);
    z-index: 10;
    border-radius: 4px;
    margin-top: 5px;
...
<div class="language-dropdown">
    ...
    <div class="language-options">
        <a href="register_vital_event_birth.php?lang=am_ET">አማ</a>
        <a href="register_vital_event_birth.php?lang=en_US">En</a>
        <a href="register_vital_event_birth.php?lang=or_ET">AO</a>
    </div>
    </div>
<div class="container">

       <center> <h5><?= __('Birth Registration Form')?></h5>
