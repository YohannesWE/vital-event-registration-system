...
<nav class="navbar navbar-expand-lg navbar-dark custom-navbar"> 
  ...
  <img src="\ksw02\logo.png"width="100" height="90" title="Logo of a company" alt="Logo of a company" />  <a class="navbar-brand" href="#" style="font-weight: bold; font-size: 19px;">GALMESSAA SIVIL KIRKOS SUB CITY WEREDA 02</a>    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link active" href="index_or.php"><?= __('home')?></a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="about_us_or.php"><?= __('About')?></a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="contactus_or.php"><?= __('Contact')?></a>
        </li>
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="register_vital_event_death_or.php"><?= __('Register Death Application')?></a>
            <a class="dropdown-item" href="view_death_check_or.php"><?= __('View Death Application')?></a>
            <div class="dropdown-divider"></div>
          </div>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="login_or.php"><?= __('Login')?></a>
        </li>
