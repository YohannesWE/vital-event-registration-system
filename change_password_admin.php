    ...
    <style>
        ...
        * {
        ...
        input[type="submit"]:hover {
            background-color:rgba(0, 111, 170, 0.36);
        }
    </style>
</head>
<body>
    ...
    if (!empty($message)) {
        echo "<div style='background-color: #f8d7da; color: #721c24; padding: 10px; text-align: center;'>$message</div>";
    }
    ?>
    ...
    <div class="containert">
        ...
        <form method="POST" action="">
            ...
            <div>
                ...
                <input type="password" name="confirm_password" pattern="^(?=.*\d)(?=.*[a-zA-Z]).{6,}$" title="Password must contain at least one letter, one number, and be at least 6 characters long" required>
            </div>
            <br>
