...
<div style="background-color:white; width:100%;">
  ...
  <a class="btn" href="customer-signup_am.php?lang=am_ET" style="margin-left: 10px; background-color:rgb(0, 110, 185); color: white;">አማርኛ</a>

  <a class="btn" href="customer-signup_or.php?lang=or_ET" style="margin-left: 10px; background-color:rgb(255, 255, 255); color: gray;">Afaan Oromo</a>
</div>
    <div class="container">
    ...
    document.getElementById('image').addEventListener('change', checkFileSize);
        ...
        <div class="login-link">
            <p><?= __('I have an account')?>? <a href="login_am.php"><?= __('Login')?></a></p>
