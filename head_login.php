...
<nav class="navbar navbar-expand-lg navbar-dark custom-navbar">
  ...
  <img src="\ksw02\logo.png"width="100" height="90" title="Logo of a company" alt="Logo of a company" />  <a class="navbar-brand" href="#" style="font-weight: bold; font-size: 19px;">KIRKOS SUBCITY WEREDA 02 VITAL EVENT REGISTRATION</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link active" href="index.php"><?= __('home')?></a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="about_us.php"><?= __('About')?></a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="contactus.php"><?= __('Contact')?></a>
        </li>
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="register_vital_event_death.php"><?= __('Register Death Application')?></a>
            <a class="dropdown-item" href="view_death_check.php"><?= __('View Death Application')?></a>
            <div class="dropdown-divider"></div>
          </div>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="login.php"><?= __('Login')?></a>
        </li>
