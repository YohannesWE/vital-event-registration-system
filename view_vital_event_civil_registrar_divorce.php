...
<td class="td_tale">
    <?php echo htmlspecialchars($row['wife_fname'] . ' ' . $row['wife_mname'] . ' ' . $row['wife_lname']); ?>
                            ...
                            <td class="tt">  <a  class="button2" href="view_certficate_divorce.php?username=<?php echo $row['username']; ?>">view</a></td>
                            <td class="td_taleee">
                      
                             <a  class="button" href="update_event_divorce.php?username=<?php echo $row['username']; ?>">Update</a>
                        </td>
                        </tr>
                <?php
                    }
