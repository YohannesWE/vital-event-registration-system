...
if (isset($_POST['signup'])) {
    ...
    if ($fileType !== 'application/pdf') {
        $message = "Please select a PDF file for the Kebele ID/fayeda.";
    } else {
...
<div class="language-dropdown">
    ...
    <div class="table-container">
        <h5><center><?= __('Applicant Signup')?></center></h5>
        <?php if ($message != ""): ?>
        ...
        <form method="POST" autocomplete="off" enctype="multipart/form-data">
           ...
           <?= __('Female')?> 
            ...
            <label for="kebele_Id_Number"><?= __('Kebele Id Number/fayeda')?></label>
    ...
    document.getElementById('image').addEventListener('change', checkFileSize);
        ...
        <div class="login-link">
            <p><?= __('I have an account')?>? <a href="login.php"><?= __('Login')?></a></p>
