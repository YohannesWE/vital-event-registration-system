...
$sql = "SELECT * FROM birth_table WHERE Birth_status = 'approved' and Payment ='paid'";
...
<head>
    ...
    <style>
        ...
        .btn:hover {
            background-color:rgba(0, 111, 170, 0.22);
        }
        .search {
            text-align: right;
        }
        ...
        <div class="table-container">
            ...
            <table>
                ...
                <?php if (mysqli_num_rows($result) == 0): ?>
                    <tr>
                        <td colspan="5"><?= __('No Ready unscheduled Birth certificate found')?>.</td>
                    </tr>
                <?php else: ?>
                    <?php while ($info = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><?php echo $info['Birth_status']; ?></td>
                            <td>
                            <a href="make_appointment.php?username=<?php echo $info['username']; ?>" style="display: inline-block; padding: 10px 20px; background-color: green; color: white; text-decoration: none; border-radius: 5px;"><?= __('Make Appointment')?></a>
